...
- `xdg.autostart.enable`, `xdg.icons.enable`, `xdg.menues.enable`, `xdg.mime.enable` and `xdg.sounds.enable` default now to false but all desktop managers in nixpkgs itself activate them.
  If you roll your own desktop, you might need to enable them explicitly.
