...
- The [drbd](https://github.com/LINBIT/drbd) out-of-tree Linux kernel driver has been added in minor version `9.2`. With it the DRBD 9.x features can be used instead of the 8.x features provided by the `8.4.11` in-tree driver. The [drbd-utils](https://github.com/LINBIT/drbd-utils) have been bumped to version 9.28.0
