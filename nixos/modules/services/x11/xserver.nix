...

{
  ...
  imports = [
    ...
    (lib.mkRenamedOptionModule
      ...
      [ "environment" "xkb" "options" ]
    )
    (lib.mkRenamedOptionModule
      [ "services" "xserver" "xkb" "variant" ]
      [ "environment" "xkb" "variant" ]
    )
  ...
  config = mkIf cfg.enable {
    ...
    ++ map (driver: {
      ...
      message = "Unknown X11 driver ‘${driver}’ specified in `videoDriver(s)`.";
    }) cfg.videoDrivers;
