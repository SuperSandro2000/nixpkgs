...
let
  cfg = config.services.gdk-pixbuf;
...
{
  imports = [
    (lib.mkRenamedOptionModule [ "services" "xserver" "gdk-pixbuf" ] [ "services" "gdk-pixbuf" ])
  ];

  options = {
    services.gdk-pixbuf.modulePackages = lib.mkOption {
