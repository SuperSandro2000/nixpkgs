{ lib, stdenv, fetchFromGitHub, autoreconfHook, pkg-config, python2, perl, bison, flex
...
stdenv.mkDerivation rec {
  ...
  nativeBuildInputs = [ autoreconfHook pkg-config python2 perl bison flex texinfo ]
